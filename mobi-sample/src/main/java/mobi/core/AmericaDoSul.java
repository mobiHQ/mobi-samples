...
public class AmericaDoSul {

	public static void main(final String[] args) throws IOException, ClassNotFoundException {
		
		Mobi mobi = AmericaDoSul.carregaDominioAmericaDoSul();

		System.out.println(mobi.getAllClasses().keySet());
		System.out.println(mobi.getAllInstances().keySet());
		System.out.println(mobi.getAllRelations().keySet());
	}
